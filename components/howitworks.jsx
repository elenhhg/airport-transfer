...
export function HowItWorks() {
  ...
  // Από 1 σε 0 opacity και 0 σε -30px translateY, πιο αργή εξαφάνιση
  const sectionOpacity = useTransform(scrollYProgress, [0, 0.8], [1, 0]);
  const sectionY = useTransform(scrollYProgress, [0, 0.8], [0, -30]);
  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-6xl">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight mb-4 text-center">
            How It Works
          </h2>
          <p className="text-lg md:text-xl text-gray-600 font-light text-center">
